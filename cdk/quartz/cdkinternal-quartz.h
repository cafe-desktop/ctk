...
extern GdkScreen *_cdk_screen;
extern GdkWindow *_cdk_root;

extern GdkDragContext *_cdk_quartz_drag_source_context;

#define GDK_WINDOW_IS_QUARTZ(win)        (GDK_IS_WINDOW_IMPL_QUARTZ (((GdkWindow *)win)->impl))

/* Initialization */
void _cdk_quartz_window_init_windowing      (GdkDisplay *display,
                                             GdkScreen  *screen);
void _cdk_quartz_events_init                (void);
void _cdk_quartz_event_loop_init            (void);

/* Cursor */
NSCursor   *_cdk_quartz_cursor_get_ns_cursor        (GdkCursor *cursor);
...
void         _cdk_quartz_events_update_focus_window    (GdkWindow *new_window,
                                                        gboolean   got_focus);
void         _cdk_quartz_events_send_map_event         (GdkWindow *window);

GdkModifierType _cdk_quartz_events_get_current_keyboard_modifiers (void);
GdkModifierType _cdk_quartz_events_get_current_mouse_modifiers    (void);

void         _cdk_quartz_events_break_all_grabs         (guint32    time);

/* Devices */
void       _cdk_quartz_device_core_set_active (GdkDevice  *device,
                                               gboolean    active,
                                               NSUInteger  device_id);

gboolean   _cdk_quartz_device_core_is_active (GdkDevice  *device,
                                              NSUInteger  device_id);

void       _cdk_quartz_device_core_set_unique (GdkDevice          *device,
                                               unsigned long long  unique_id);

unsigned long long _cdk_quartz_device_core_get_unique (GdkDevice *device);
...
/* Keys */
GdkEventType _cdk_quartz_keys_event_type  (NSEvent   *event);
gboolean     _cdk_quartz_keys_is_modifier (guint      keycode);
void         _cdk_quartz_synthesize_null_key_event (GdkWindow *window);

/* Drag and Drop */
void        _cdk_quartz_window_register_dnd      (GdkWindow   *window);
GdkDragContext * _cdk_quartz_window_drag_begin   (GdkWindow   *window,
                                                  GdkDevice   *device,
                                                  GList       *targets,
                                                  gint         x_root,
                                                  gint         y_root);
...
/* Screen */
GdkScreen  *_cdk_quartz_screen_new                      (void);
void        _cdk_quartz_screen_update_window_sizes      (GdkScreen *screen);

/* Screen methods - visual */
GdkVisual *   _cdk_quartz_screen_get_rgba_visual            (GdkScreen      *screen);
GdkVisual *   _cdk_quartz_screen_get_system_visual          (GdkScreen      *screen);
gint          _cdk_quartz_screen_visual_get_best_depth      (GdkScreen      *screen);
GdkVisualType _cdk_quartz_screen_visual_get_best_type       (GdkScreen      *screen);
GdkVisual *   _cdk_quartz_screen_get_system_visual          (GdkScreen      *screen);
GdkVisual*    _cdk_quartz_screen_visual_get_best            (GdkScreen      *screen);
GdkVisual*    _cdk_quartz_screen_visual_get_best_with_depth (GdkScreen      *screen,
                                                             gint            depth);
GdkVisual*    _cdk_quartz_screen_visual_get_best_with_type  (GdkScreen      *screen,
                                                             GdkVisualType   visual_type);
GdkVisual*    _cdk_quartz_screen_visual_get_best_with_both  (GdkScreen      *screen,
                                                             gint            depth,
                                                             GdkVisualType   visual_type);
void          _cdk_quartz_screen_query_depths               (GdkScreen      *screen,
                                                             gint          **depths,
                                                             gint           *count);
void          _cdk_quartz_screen_query_visual_types         (GdkScreen      *screen,
                                                             GdkVisualType **visual_types,
                                                             gint           *count);
void          _cdk_quartz_screen_init_visuals               (GdkScreen      *screen);
GList *       _cdk_quartz_screen_list_visuals               (GdkScreen      *screen);

/* Screen methods - events */
void        _cdk_quartz_screen_broadcast_client_message (GdkScreen   *screen,
                                                         GdkEvent    *event);
gboolean    _cdk_quartz_screen_get_setting              (GdkScreen   *screen,
                                                         const gchar *name,
                                                         GValue      *value);

gboolean    _cdk_quartz_window_is_ancestor          (GdkWindow *ancestor,
                                                     GdkWindow *window);
...
void       _cdk_quartz_window_nspoint_to_cdk_xy     (NSPoint    point,
                                                     gint      *x,
                                                     gint      *y);
GdkWindow *_cdk_quartz_window_find_child            (GdkWindow *window,
                                                     gint       x,
                                                     gint       y,
                                                     gboolean   get_toplevel);
void       _cdk_quartz_window_attach_to_parent      (GdkWindow *window);
void       _cdk_quartz_window_detach_from_parent    (GdkWindow *window);
void       _cdk_quartz_window_did_become_main       (GdkWindow *window);
void       _cdk_quartz_window_did_resign_main       (GdkWindow *window);
void       _cdk_quartz_window_debug_highlight       (GdkWindow *window,
                                                     gint       number);

void       _cdk_quartz_window_update_position           (GdkWindow    *window);
void       _cdk_quartz_window_update_fullscreen_state   (GdkWindow    *window);

/* Window methods - testing */
void     _cdk_quartz_window_sync_rendering    (GdkWindow       *window);
gboolean _cdk_quartz_window_simulate_key      (GdkWindow       *window,
                                               gint             x,
                                               gint             y,
                                               guint            keyval,
                                               GdkModifierType  modifiers,
                                               GdkEventType     key_pressrelease);
gboolean _cdk_quartz_window_simulate_button   (GdkWindow       *window,
                                               gint             x,
                                               gint             y,
                                               guint            button,
                                               GdkModifierType  modifiers,
...
gboolean _cdk_quartz_window_get_property      (GdkWindow    *window,
                                               GdkAtom       property,
                                               GdkAtom       type,
                                               gulong        offset,
                                               gulong        length,
                                               ...
                                               gint         *actual_length,
                                               guchar      **data);
void     _cdk_quartz_window_change_property   (GdkWindow    *window,
                                               GdkAtom       property,
                                               GdkAtom       type,
                                               gint          format,
                                               GdkPropMode   mode,
                                               const guchar *data,
                                               gint          nelements);
void     _cdk_quartz_window_delete_property   (GdkWindow    *window,
                                               GdkAtom       property);
