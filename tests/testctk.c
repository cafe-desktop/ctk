...
static CtkActionEntry create_toolbar_items[] = {
    { .stock_id = CTK_STOCK_NEW, .tooltip = "Stock icon: New", .callback = G_CALLBACK (set_toolbar_small_stock) },
    { .stock_id = CTK_STOCK_OPEN, .tooltip = "Stock icon: Open", .callback = G_CALLBACK (set_toolbar_large_stock) },
    { .label = "Horizontal", .tooltip = "Horizontal toolbar layout", .callback = G_CALLBACK (set_toolbar_horizontal) },
    { .label = "Vertical", .tooltip = "Vertical toolbar layout", .callback = G_CALLBACK (set_toolbar_vertical) },
    { NULL },
    { .label = "Icons", .tooltip = "Only show toolbar icons", .callback = G_CALLBACK (set_toolbar_icons) },
    { .label = "Text", .tooltip = "Only show toolbar text", .callback = G_CALLBACK (set_toolbar_text) },
    ...
    { .label = "Baz", .tooltip = "Baz tooltip" },
    { NULL },
    { .label = "Blah", .tooltip = "Blash tooltip" },
...
{
  { .label = "alpha window",      .func = create_alpha_window },
  { .label = "alpha widget",      .func = create_alpha_widgets },
  { .label = "big windows",       .func = create_big_windows },
  { .label = "button box",        .func = create_button_box },
  { .label = "buttons",           .func = create_buttons },
  { .label = "check buttons",     .func = create_check_buttons },
  { .label = "color selection",   .func = create_color_selection },
  { .label = "composited window", .func = create_composited_window },
  { .label = "cursors",           .func = create_cursors },
  { .label = "dialog",            .func = create_dialog },
  { .label = "display",           .func = create_display_screen, .do_not_benchmark = TRUE },
  { .label = "entry",             .func = create_entry },
  { .label = "event box",         .func = create_event_box },
  { .label = "event watcher",     .func = create_event_watcher },
  { .label = "expander",          .func = create_expander },
  { .label = "flipping",          .func = create_flipping },
  { .label = "focus",             .func = create_focus },
  { .label = "font selection",    .func = create_font_selection },
  { .label = "image",             .func = create_image },
  { .label = "key lookup",        .func = create_key_lookup },
  { .label = "labels",            .func = create_labels },
  { .label = "layout",            .func = create_layout },
  { .label = "listbox",           .func = create_listbox },
  { .label = "menus",             .func = create_menus },
  { .label = "message dialog",    .func = create_message_dialog },
  { .label = "modal window",      .func = create_modal_window, .do_not_benchmark = TRUE },
  { .label = "native dialogs",    .func = create_native_dialogs },
  { .label = "notebook",          .func = create_notebook },
  { .label = "panes",             .func = create_panes },
  { .label = "paned keyboard",    .func = create_paned_keyboard_navigation },
  { .label = "pixbuf",            .func = create_pixbuf },
  { .label = "progress bar",      .func = create_progress_bar },
  { .label = "radio buttons",     .func = create_radio_buttons },
  { .label = "range controls",    .func = create_range_controls },
  { .label = "reparent",          .func = create_reparent },
  { .label = "resize grips",      .func = create_resize_grips },
  { .label = "rotated label",     .func = create_rotated_label },
  { .label = "rotated text",      .func = create_rotated_text },
  { .label = "saved position",    .func = create_saved_position },
  { .label = "scrolled windows",  .func = create_scrolled_windows },
  { .label = "shapes",            .func = create_shapes },
  { .label = "size groups",       .func = create_size_groups },
  { .label = "snapshot",          .func = create_snapshot },
  { .label = "spinbutton",        .func = create_spins },
  { .label = "statusbar",         .func = create_statusbar },
  { .label = "test mainloop",     .func = create_mainloop, .do_not_benchmark = TRUE },
  { .label = "test scrolling",    .func = create_scroll_test },
  { .label = "test selection",    .func = create_selection_test },
  { .label = "test timeout",      .func = create_timeout_test },
  { .label = "toggle buttons",    .func = create_toggle_buttons },
  { .label = "toolbar",           .func = create_toolbar },
  { .label = "tooltips",          .func = create_tooltips },
  { .label = "WM hints",          .func = create_wmhints },
  { .label = "window sizing",     .func = create_window_sizing },
  { .label = "window states",     .func = create_window_states }
};
