...
static TestInterface interfaces[] = {
  {
    ...
    "        </child>"
    "        <child>"
    "          <object class=\"CtkLabel\" id=\"label10\">"
    "            <property name=\"visible\">True</property>"
...

  {
    ...
    "    <child>"
    "      <object class=\"CtkPaned\" id=\"hpaned1\">"
    "        <property name=\"orientation\">horizontal</property>"
    "        <property name=\"visible\">True</property>"
...

  {
    ...
    "    <child>"
    "      <object class=\"CtkPaned\" id=\"vpaned1\">"
    "        <property name=\"orientation\">vertical</property>"
    "        <property name=\"visible\">True</property>"
    "        <property name=\"can_focus\">True</property>"
    "        <child>"
...

  {
    ...
    "        <property name=\"can_focus\">True</property>"
    "        <child>"
    "          <object class=\"CtkExpander\" id=\"expander1\">"
    "            <property name=\"visible\">True</property>"
    "            <property name=\"can_focus\">True</property>"
    "            <child>"
    "              <object class=\"CtkLabel\" id=\"label2\">"
...

  {
    ...
    "                    <child>"
    "                      <object class=\"CtkCellRendererPixbuf\" id=\"cellrenderertext1\"/>"
    "                      <attributes>"
    "                        <attribute name=\"icon-name\">1</attribute>"
    "                      </attributes>"
    "                    </child>"
    "                    <child>"
    "                      <object class=\"CtkCellRendererText\" id=\"cellrenderertext2\">"
    ...
    "                </child>"
    "                <child>"
    "                  <object class=\"CtkComboBox\" id=\"combobox2\">"
    "                    <property name=\"visible\">True</property>"
    "                    <property name=\"model\">liststore1</property>"
    "                    <property name=\"active\">0</property>"
    "                    <child>"
    "                      <object class=\"CtkCellRendererPixbuf\" id=\"cellrenderertext3\"/>"
    "                      <attributes>"
    "                        <attribute name=\"icon-name\">1</attribute>"
    "                      </attributes>"
    "                    </child>"
  ...
  if (!interface->window)
    {
      ...
      if (error)
        {
          g_printerr ("CtkBuilder for interface \"%s\" returned error \"%s\"\n",
      ...
      interface->window = (CtkWidget *)ctk_builder_get_object (builder, "window");
