		 ...
		 WidgetSize  size)
{
  ...
  if (GTK_IS_WINDOW (widget))
    {
      info->window = widget;
      ctk_window_set_resizable (GTK_WINDOW (info->window), FALSE);
      info->include_decorations = TRUE;
    }
  else
    {
      info->window = ctk_window_new (GTK_WINDOW_TOPLEVEL);
      ctk_container_set_border_width (GTK_CONTAINER (info->window), 12);
      info->include_decorations = FALSE;
      ctk_widget_show_all (widget);
      ctk_container_add (GTK_CONTAINER (info->window), widget);
    }
  info->no_focus = TRUE;
...
create_button (void)
{
  ...
  ctk_container_add (GTK_CONTAINER (align), widget);
...
create_switch (void)
{
  ...
  widget = ctk_box_new (GTK_ORIENTATION_VERTICAL, 3);
  sw = ctk_switch_new ();
  ctk_switch_set_active (GTK_SWITCH (sw), TRUE);
  ctk_box_pack_start (GTK_BOX (widget), sw, TRUE, TRUE, 0);
  sw = ctk_switch_new ();
  ctk_box_pack_start (GTK_BOX (widget), sw, TRUE, TRUE, 0);
...
create_menu_button (void)
{
  ...
  image = ctk_image_new ();
  ctk_image_set_from_icon_name (GTK_IMAGE (image), "emblem-system-symbolic", GTK_ICON_SIZE_MENU);
  ctk_button_set_image (GTK_BUTTON (widget), image);
  menu = ctk_menu_new ();
  ctk_menu_button_set_popup (GTK_MENU_BUTTON (widget), menu);
  ...
  ctk_box_pack_start (GTK_BOX (vbox), ctk_label_new ("Menu Button"), TRUE, TRUE, 0);
...
create_entry (void)
{
  ...
  ctk_entry_set_text (GTK_ENTRY (widget), "Entry");
...
create_search_entry (void)
{
  ...
  ctk_entry_set_placeholder_text (GTK_ENTRY (widget), "Search...");
  align = ctk_alignment_new (0.5, 0.5, 1.0, 0.0);
  ctk_container_add (GTK_CONTAINER (align), widget);
...
create_radio (void)
{
  ...
  ctk_box_pack_start (GTK_BOX (widget), radio, FALSE, FALSE, 0);
  radio = ctk_radio_button_new_with_mnemonic_from_widget (GTK_RADIO_BUTTON (radio), "Radio Button _Two");
  ctk_box_pack_start (GTK_BOX (widget), radio, FALSE, FALSE, 0);
  radio = ctk_radio_button_new_with_mnemonic_from_widget (GTK_RADIO_BUTTON (radio), "Radio Button T_hree");
  ctk_box_pack_start (GTK_BOX (widget), radio, FALSE, FALSE, 0);
  align = ctk_alignment_new (0.5, 0.5, 0.0, 0.0);
  ctk_container_add (GTK_CONTAINER (align), widget);
...
create_accel_label (void)
{
  ...
  ctk_accel_label_set_accel_widget (GTK_ACCEL_LABEL (widget), button);
...
create_combo_box_entry (void)
{
  ...
  ctk_entry_set_text (GTK_ENTRY (child), "Combo Box Entry");
  align = ctk_alignment_new (0.5, 0.5, 0.0, 0.0);
  ctk_container_add (GTK_CONTAINER (align), widget);
...
create_combo_box (void)
{
  ...
  ctk_cell_layout_pack_start (GTK_CELL_LAYOUT (widget), cell, FALSE);
  ctk_cell_layout_set_attributes (GTK_CELL_LAYOUT (widget), cell, "text", 0, NULL);
...
create_combo_box_text (void)
{
  ...
  ctk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (widget), "Combo Box Text");
  ctk_combo_box_set_active (GTK_COMBO_BOX (widget), 0);
  align = ctk_alignment_new (0.5, 0.5, 0.0, 0.0);
  ctk_container_add (GTK_CONTAINER (align), widget);
...
create_info_bar (void)
{
  ...
  ctk_info_bar_set_show_close_button (GTK_INFO_BAR (widget), TRUE);
  ctk_info_bar_set_message_type (GTK_INFO_BAR (widget), GTK_MESSAGE_INFO);
  ctk_container_add (GTK_CONTAINER (ctk_info_bar_get_content_area (GTK_INFO_BAR (widget))),
  ...
  ctk_container_set_border_width (GTK_CONTAINER (info->window), 0);
...
create_search_bar (void)
{
  ...
  ctk_entry_set_text (GTK_ENTRY (entry), "Search Bar");
  ctk_container_add (GTK_CONTAINER (widget), entry);
  ctk_widget_show (entry);

  ctk_search_bar_set_show_close_button (GTK_SEARCH_BAR (widget), TRUE);
  ctk_search_bar_set_search_mode (GTK_SEARCH_BAR (widget), TRUE);

  ctk_container_add (GTK_CONTAINER (box), widget);

  view = ctk_text_view_new ();
  ctk_widget_show (view);
  ctk_box_pack_start (GTK_BOX (box), view, TRUE, TRUE, 0);
...
create_action_bar (void)
{
  ...
  button = ctk_button_new_from_icon_name ("object-select-symbolic", GTK_ICON_SIZE_MENU);
  ctk_widget_show (button);
  ctk_container_add (GTK_CONTAINER (widget), button);
  button = ctk_button_new_from_icon_name ("call-start-symbolic", GTK_ICON_SIZE_MENU);
  ctk_widget_show (button);
  ctk_container_add (GTK_CONTAINER (widget), button);
...
create_recent_chooser_dialog (void)
{
  ...
  widget = ctk_recent_chooser_dialog_new ("Recent Chooser Dialog",
					  ...
					  NULL); 
  ctk_window_set_default_size (GTK_WINDOW (widget), 505, 305);
...
create_text_view (void)
{
  ...
  ctk_frame_set_shadow_type (GTK_FRAME (widget), GTK_SHADOW_IN);
  text_view = ctk_text_view_new ();
  ctk_container_add (GTK_CONTAINER (widget), text_view);
  /* Bad hack to add some size to the widget */
  ctk_text_buffer_set_text (ctk_text_view_get_buffer (GTK_TEXT_VIEW (text_view)),
			    "Multiline\nText\n\n", -1);
...
create_tree_view (void)
{
  ...
  ctk_tree_view_set_enable_tree_lines (GTK_TREE_VIEW (tree_view), TRUE);
  ...
  ctk_container_add (GTK_CONTAINER (widget), tree_view);
...
create_icon_view (void)
{
  ...
  ctk_icon_view_set_model (GTK_ICON_VIEW (icon_view), GTK_TREE_MODEL (list_store));
  ctk_icon_view_set_text_column (GTK_ICON_VIEW (icon_view), 0);
  ctk_icon_view_set_pixbuf_column (GTK_ICON_VIEW (icon_view), 1);

  ctk_container_add (GTK_CONTAINER (widget), icon_view);

  vbox = ctk_box_new (GTK_ORIENTATION_VERTICAL, 3);
  align = ctk_alignment_new (0.5, 0.5, 1.0, 1.0);
  ctk_container_add (GTK_CONTAINER (align), widget);
  ctk_box_pack_start (GTK_BOX (vbox), align, TRUE, TRUE, 0);
  ctk_box_pack_start (GTK_BOX (vbox),
...
create_color_button (void)
{
  ...
  ctk_container_add (GTK_CONTAINER (align), picker);
  ctk_box_pack_start (GTK_BOX (vbox), align, FALSE, FALSE, 0);
  ctk_box_pack_start (GTK_BOX (vbox),
...
create_file_button (void)
{
  ...
  ctk_box_pack_start (GTK_BOX (vbox),
		      vbox2, TRUE, TRUE, 0);
  ctk_box_pack_start (GTK_BOX (vbox),
		      ctk_separator_new (GTK_ORIENTATION_HORIZONTAL),
		      FALSE, FALSE, 0);
  ...
  ctk_file_chooser_set_filename (GTK_FILE_CHOOSER (picker), path);
  g_free (path);
  ctk_container_add (GTK_CONTAINER (align), picker);
  ctk_box_pack_start (GTK_BOX (vbox2), align, FALSE, FALSE, 0);
  ctk_box_pack_start (GTK_BOX (vbox2),
...
create_separator (void)
{
  ...
  ctk_box_pack_start (GTK_BOX (hbox),
		      ...
		      TRUE, TRUE, 0);
  ctk_box_pack_start (GTK_BOX (hbox),
		      ctk_separator_new (GTK_ORIENTATION_VERTICAL),
		      TRUE, TRUE, 0);
...
create_panes (void)
{
  ...
  ctk_box_set_homogeneous (GTK_BOX (hbox), TRUE);
  pane = ctk_paned_new (GTK_ORIENTATION_HORIZONTAL);
  ctk_paned_pack1 (GTK_PANED (pane),
		   g_object_new (GTK_TYPE_FRAME,
				 "shadow-type", GTK_SHADOW_IN,
				 NULL),
		   FALSE, FALSE);
  ctk_paned_pack2 (GTK_PANED (pane),
		   g_object_new (GTK_TYPE_FRAME,
				 "shadow-type", GTK_SHADOW_IN,
				 NULL),
		   FALSE, FALSE);
...
create_window (void)
{
  ...
  info->include_decorations = TRUE;
  ctk_window_set_title (GTK_WINDOW (info->window), "Window");
...
create_page_setup_dialog (void)
{
  ...
  ctk_page_setup_unix_dialog_set_page_setup (GTK_PAGE_SETUP_UNIX_DIALOG (widget),
					     page_setup);
  ctk_page_setup_unix_dialog_set_print_settings (GTK_PAGE_SETUP_UNIX_DIALOG (widget),
						 settings);
...
create_toolbar (void)
{
  ...
  ctk_toolbar_insert (GTK_TOOLBAR (widget), item, -1);
  ...
  item = ctk_tool_button_new (NULL, NULL);
  ctk_tool_button_set_icon_name (GTK_TOOL_BUTTON (item), "view-refresh");
  ctk_toolbar_insert (GTK_TOOLBAR (widget), item, -1);

  ctk_toolbar_set_show_arrow (GTK_TOOLBAR (widget), FALSE);
...
create_toolpalette (void)
{
  ...
  ctk_container_add (GTK_CONTAINER (widget), group);
  item = ctk_tool_button_new (NULL, NULL);
  ctk_tool_button_set_icon_name (GTK_TOOL_BUTTON (item), "help-about");
  ctk_tool_item_group_insert (GTK_TOOL_ITEM_GROUP (group), item, -1);
  item = ctk_tool_button_new (NULL, NULL);
  ctk_tool_button_set_icon_name (GTK_TOOL_BUTTON (item), "document-new");
  ctk_tool_item_group_insert (GTK_TOOL_ITEM_GROUP (group), item, -1);
  item = ctk_tool_button_new (NULL, NULL);
  ctk_tool_button_set_icon_name (GTK_TOOL_BUTTON (item), "folder");
  ctk_tool_item_group_insert (GTK_TOOL_ITEM_GROUP (group), item, -1);

  group = ctk_tool_item_group_new ("More tools");
  ctk_container_add (GTK_CONTAINER (widget), group);
  item = ctk_tool_button_new (NULL, NULL);
  ctk_tool_button_set_icon_name (GTK_TOOL_BUTTON (item), "edit-cut");
  ctk_tool_item_group_insert (GTK_TOOL_ITEM_GROUP (group), item, -1);
  item = ctk_tool_button_new (NULL, NULL);
  ctk_tool_button_set_icon_name (GTK_TOOL_BUTTON (item), "edit-find");
  ctk_tool_item_group_insert (GTK_TOOL_ITEM_GROUP (group), item, -1);
  item = ctk_tool_button_new (NULL, NULL);
  ctk_tool_button_set_icon_name (GTK_TOOL_BUTTON (item), "document-properties");
  ctk_tool_item_group_insert (GTK_TOOL_ITEM_GROUP (group), item, -1);
...
create_menubar (void)
{
  ...
  ctk_menu_shell_append (GTK_MENU_SHELL (widget), item);
...
create_message_dialog (void)
{
  ...
  widget = ctk_message_dialog_new (NULL,
				   ...
				   GTK_BUTTONS_OK,
				   NULL);
  ctk_window_set_icon_name (GTK_WINDOW (widget), "edit-copy");
  ctk_message_dialog_set_markup (GTK_MESSAGE_DIALOG (widget), "Message Dialog");
  ctk_message_dialog_format_secondary_text (GTK_MESSAGE_DIALOG (widget), "%s", "With secondary text");
...
create_about_dialog (void)
{
  ...
  g_object_set (widget,
                ...
                "authors", authors,
		NULL);
  ctk_window_set_icon_name (GTK_WINDOW (widget), "help-about");
...
create_notebook (void)
{
  ...
  ctk_notebook_append_page (GTK_NOTEBOOK (widget), 
			    ctk_label_new ("Notebook"),
			    NULL);
  ctk_notebook_append_page (GTK_NOTEBOOK (widget), ctk_event_box_new (), NULL);
  ctk_notebook_append_page (GTK_NOTEBOOK (widget), ctk_event_box_new (), NULL);
...
create_progressbar (void)
{
  ...
  ctk_progress_bar_set_fraction (GTK_PROGRESS_BAR (widget), 0.5);
...
create_level_bar (void)
{
  ...
  ctk_level_bar_set_value (GTK_LEVEL_BAR (widget), 0.333);

  vbox = ctk_box_new (GTK_ORIENTATION_VERTICAL, 3);
  ctk_box_pack_start (GTK_BOX (vbox), widget, TRUE, FALSE, 0);
  ctk_box_pack_start (GTK_BOX (vbox),
...
create_scrolledwindow (void)
{
  ...
  ctk_scrolled_window_set_policy (GTK_SCROLLED_WINDOW (scrolledwin),
                                  GTK_POLICY_NEVER, GTK_POLICY_ALWAYS);
  label = ctk_label_new ("Scrolled Window");

  ctk_container_add (GTK_CONTAINER (scrolledwin), label);
...
create_scrollbar (void)
{
  ...
  widget = ctk_scrollbar_new (GTK_ORIENTATION_HORIZONTAL, NULL);
...
create_statusbar (void)
{
  ...
  align = ctk_alignment_new (0.5, 0.5, 0.0, 0.0);
  ctk_container_add (GTK_CONTAINER (align), ctk_label_new ("Status Bar"));
  ctk_box_pack_start (GTK_BOX (vbox),
		      align,
		      FALSE, FALSE, 0);
  ...
  ctk_container_add (GTK_CONTAINER (align), widget);
  ctk_statusbar_push (GTK_STATUSBAR (widget), 0, "Hold on...");

  ctk_box_pack_end (GTK_BOX (vbox), align, FALSE, FALSE, 0);
...
create_scales (void)
{
  ...
  ctk_box_set_homogeneous (GTK_BOX (hbox), TRUE);
  ctk_box_pack_start (GTK_BOX (hbox),
		      ctk_scale_new_with_range (GTK_ORIENTATION_HORIZONTAL,
                                                0.0, 100.0, 1.0),
		      TRUE, TRUE, 0);
  ctk_box_pack_start (GTK_BOX (hbox),
		      ctk_scale_new_with_range (GTK_ORIENTATION_VERTICAL,
                                                0.0, 100.0, 1.0),
		      TRUE, TRUE, 0);
  ctk_box_pack_start (GTK_BOX (vbox), hbox, TRUE, TRUE, 0);
  ctk_box_pack_start (GTK_BOX (vbox),
...
create_volume_button (void)
{
  ...
  ctk_box_pack_end (GTK_BOX (box), button, FALSE, FALSE, 0);

  ctk_scale_button_set_value (GTK_SCALE_BUTTON (button), 33);
  popup = ctk_scale_button_get_popup (GTK_SCALE_BUTTON (button));
...
create_assistant (void)
{
  ...
  ctk_window_set_title (GTK_WINDOW (widget), "Assistant");

  page1 = ctk_label_new ("Assistant");
  ctk_widget_show (page1);
  ctk_widget_set_size_request (page1, 300, 140);
  ctk_assistant_prepend_page (GTK_ASSISTANT (widget), page1);
  ctk_assistant_set_page_title (GTK_ASSISTANT (widget), page1, "Assistant page");
  ctk_assistant_set_page_complete (GTK_ASSISTANT (widget), page1, TRUE);

  page2 = ctk_label_new (NULL);
  ctk_widget_show (page2);
  ctk_assistant_append_page (GTK_ASSISTANT (widget), page2);
  ctk_assistant_set_page_type (GTK_ASSISTANT (widget), page2, GTK_ASSISTANT_PAGE_CONFIRM);
...
create_appchooserdialog (void)
{
  ...
  ctk_window_set_default_size (GTK_WINDOW (widget), 200, 300);
...
create_headerbar (void)
{
  ...
  ctk_header_bar_set_title (GTK_HEADER_BAR (bar), "Header Bar");
  ctk_header_bar_set_subtitle (GTK_HEADER_BAR (bar), "(subtitle)");
  ctk_window_set_titlebar (GTK_WINDOW (window), bar);
  button = ctk_button_new ();
  ctk_container_add (GTK_CONTAINER (button), ctk_image_new_from_icon_name ("bookmark-new-symbolic", GTK_ICON_SIZE_BUTTON));
  ctk_header_bar_pack_end (GTK_HEADER_BAR (bar), button);
...
create_placessidebar (void)
{
  ...
  ctk_container_add (GTK_CONTAINER (align), bar);
  ctk_box_pack_start (GTK_BOX (vbox), align, FALSE, FALSE, 0);
  ctk_box_pack_start (GTK_BOX (vbox),
...
create_stack (void)
{
  ...
  view = ctk_text_view_new ();
  ctk_widget_show (view);
  ctk_stack_add_titled (GTK_STACK (stack), view, "page1", "Page 1");
  view = ctk_text_view_new ();
  ctk_widget_show (view);
  ctk_stack_add_titled (GTK_STACK (stack), view, "page2", "Page 2");

  switcher = ctk_stack_switcher_new ();
  ctk_stack_switcher_set_stack (GTK_STACK_SWITCHER (switcher), GTK_STACK (stack));
  ctk_widget_set_halign (switcher, GTK_ALIGN_CENTER);

  vbox = ctk_box_new (GTK_ORIENTATION_VERTICAL, 0);

  ctk_box_pack_start (GTK_BOX (vbox), switcher, FALSE, FALSE, 0);
  ctk_box_pack_start (GTK_BOX (vbox), stack, FALSE, FALSE, 0);
  ctk_box_pack_start (GTK_BOX (vbox),
                      ctk_label_new ("Stack"),
                      FALSE, FALSE, 0);
...
create_sidebar (void)
{
  ...
  ctk_widget_set_halign (view, GTK_ALIGN_FILL);
  ctk_widget_set_valign (view, GTK_ALIGN_FILL);
  ctk_widget_show (view);
  ctk_stack_add_titled (GTK_STACK (stack), view, "page1", "Page 1");
  view = ctk_text_view_new ();
  ctk_widget_show (view);
  ...
  ctk_box_pack_start (GTK_BOX (hbox), sidebar, FALSE, FALSE, 0);
  ctk_box_pack_start (GTK_BOX (hbox), ctk_separator_new (GTK_ORIENTATION_VERTICAL), FALSE, FALSE, 0);
  ctk_box_pack_start (GTK_BOX (hbox), stack, TRUE, TRUE, 0);
...
create_list_box (void)
{
  ...
  ctk_list_box_set_selection_mode (GTK_LIST_BOX (list), GTK_SELECTION_BROWSE);
  ...
  row = ctk_box_new (GTK_ORIENTATION_HORIZONTAL, 10);
  ctk_container_add (GTK_CONTAINER (row), ctk_label_new ("Line One"));
  ...
  ctk_container_add (GTK_CONTAINER (row), button);
  ctk_container_add (GTK_CONTAINER (list), row);
  ctk_list_box_select_row (GTK_LIST_BOX (list), GTK_LIST_BOX_ROW (ctk_widget_get_parent (row)));
  row = ctk_box_new (GTK_ORIENTATION_HORIZONTAL, 10);
  ctk_container_add (GTK_CONTAINER (row), ctk_label_new ("Line Two"));
  ...
  ctk_container_add (GTK_CONTAINER (list), row);
  row = ctk_box_new (GTK_ORIENTATION_HORIZONTAL, 10);
  ctk_container_add (GTK_CONTAINER (row), ctk_label_new ("Line Three"));
  ...
  ctk_container_add (GTK_CONTAINER (widget), list);
...
create_flow_box (void)
{
  ...
  ctk_flow_box_set_min_children_per_line (GTK_FLOW_BOX (box), 2);
  ctk_flow_box_set_max_children_per_line (GTK_FLOW_BOX (box), 2);
  ctk_flow_box_set_selection_mode (GTK_FLOW_BOX (box), GTK_SELECTION_BROWSE);
  button = ctk_label_new ("Child One");
  ctk_container_add (GTK_CONTAINER (box), button);
  button = ctk_button_new_with_label ("Child Two");
  ctk_container_add (GTK_CONTAINER (box), button);
  child = ctk_box_new (GTK_ORIENTATION_HORIZONTAL, 6);
  ctk_container_add (GTK_CONTAINER (child), ctk_label_new ("Child Three"));
  button = ctk_check_button_new ();
  ctk_toggle_button_set_active (GTK_TOGGLE_BUTTON (button), TRUE);
  ctk_container_add (GTK_CONTAINER (child), button);
  ctk_container_add (GTK_CONTAINER (box), child);
  ctk_flow_box_select_child (GTK_FLOW_BOX (box),
                             GTK_FLOW_BOX_CHILD (ctk_widget_get_parent (child)));
  ...
  ctk_box_pack_start (GTK_BOX (vbox), widget, FALSE, FALSE, 0);
  ctk_box_pack_start (GTK_BOX (vbox), ctk_label_new ("Flow Box"),
                      FALSE, FALSE, 0);
...
create_gl_area (void)
{
  ...
  gears = ctk_gears_new ();
  ctk_container_add (GTK_CONTAINER (widget), gears);
