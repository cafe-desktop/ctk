...
am_et_register_type (GTypeModule *module)
{
  const GTypeInfo object_info =
  {
    ...
    .class_init = (GClassInitFunc) am_et_class_init,
    .instance_size = sizeof (CtkIMContextSimple),
    .n_preallocs = 0,
    .instance_init = (GInstanceInitFunc) am_et_init,
  };
...
#else
#define MODULE_ENTRY(type, function) type _ctk_immodule_am_et_ ## function
#endif
