...
static void ti_er_class_init (CtkIMContextSimpleClass *class);
static void ti_er_init (CtkIMContextSimple *im_context);
...
ti_er_register_type (GTypeModule *module)
{
  const GTypeInfo object_info =
  {
    ...
    .class_init = (GClassInitFunc) ti_er_class_init,
    .instance_size = sizeof (CtkIMContextSimple),
    .n_preallocs = 0,
    .instance_init = (GInstanceInitFunc) ti_er_init,
  };

  type_ti_er_translit = 
    g_type_module_register_type (module,
				 CTK_TYPE_IM_CONTEXT_SIMPLE,
				 "CtkIMContextTigrignaEritrea",
				 &object_info, 0);
}
...
static guint16 ti_er_compose_seqs[] = {
  ...
  '\'',   0, 0, 0, 0, 0, CDK_KEY_dead_grave,  /* hopefully this has no side effects */
  '\'', '\'', 0, 0, 0, 0, CDK_KEY_apostrophe,
  '\'', '1', 0, 0, 0, 0, 0x1369,
  '\'', '1', '0', 0, 0, 0, 0x1372,
  '\'', '1', '0', '0', 0, 0, 0x137b,
  '\'', '1', '0', 'k', 0, 0, 0x137c,
  ...
  SYL('y', 0x12e8)
  SYLW('z', 0x12d8)
  CDK_KEY_Shift_L, CDK_KEY_space, 0, 0, 0, 0, 0x1361,
  CDK_KEY_Shift_R, CDK_KEY_space, 0, 0, 0, 0, 0x1361,
};

static void
ti_er_class_init (CtkIMContextSimpleClass *class G_GNUC_UNUSED)
{
}

static void
ti_er_init (CtkIMContextSimple *im_context)
{
...
static const CtkIMContextInfo ti_er_info = { 
  "ti_er",		   /* ID */
...
#else
#define MODULE_ENTRY(type, function) type _ctk_immodule_ti_er_ ## function
#endif
