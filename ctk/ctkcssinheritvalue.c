...
static void
ctk_css_value_inherit_free (CtkCssValue *value G_GNUC_UNUSED)
{
...
static CtkCssValue *
ctk_css_value_inherit_compute (CtkCssValue             *value G_GNUC_UNUSED,
                               guint                    property_id,
...
static gboolean
ctk_css_value_inherit_equal (const CtkCssValue *value1 G_GNUC_UNUSED,
...
static CtkCssValue *
ctk_css_value_inherit_transition (CtkCssValue *start G_GNUC_UNUSED,
...
static void
ctk_css_value_inherit_print (const CtkCssValue *value G_GNUC_UNUSED,
                             GString           *string)
{
