...
void
ctk_print_win32_devnames_free (CtkPrintWin32Devnames *devnames)
{
...
ctk_print_win32_devnames_from_win32 (HGLOBAL global)
{
  ...
  CtkPrintWin32Devnames *devnames = g_new (CtkPrintWin32Devnames, 1);
...
HGLOBAL 
ctk_print_win32_devnames_to_win32 (const CtkPrintWin32Devnames *devnames)
{
  HGLOBAL global;
...
{
  HGLOBAL global;
  CtkPrintWin32Devnames *devnames;
  ...
  if (OpenPrinterW (win32_printer_name, &hprinter, NULL))
    {
      ...
      devnames = g_new (CtkPrintWin32Devnames, 1);
