...
void       _ctk_check_menu_item_set_active       (CtkCheckMenuItem *check_menu_item,
                                                  gboolean          is_active);
CtkCssGadget * _ctk_check_menu_item_get_indicator_gadget (CtkCheckMenuItem *check_menu_item);
