...
G_DEFINE_TYPE_WITH_CODE (CtkPanedAccessible, ctk_paned_accessible, CTK_TYPE_CONTAINER_ACCESSIBLE,
...
static void
ctk_paned_accessible_class_init (CtkPanedAccessibleClass *klass)
{
