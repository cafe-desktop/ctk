...
G_DEFINE_TYPE_WITH_CODE (GtkTreeViewAccessible, ctk_tree_view_accessible, CTK_TYPE_CONTAINER_ACCESSIBLE,
...
{
  GtkTreeViewAccessible *accessible = CTK_TREE_VIEW_ACCESSIBLE (object);
