...
#ifndef __CTK_MENU_SHELL_ACCESSIBLE_H__
#define __CTK_MENU_SHELL_ACCESSIBLE_H__
...
GType ctk_menu_shell_accessible_get_type (void);

G_END_DECLS

#endif /* __CTK_MENU_SHELL_ACCESSIBLE_H__ */
