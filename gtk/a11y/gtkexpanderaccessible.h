...
#define CTK_EXPANDER_ACCESSIBLE(obj)              (G_TYPE_CHECK_INSTANCE_CAST ((obj), CTK_TYPE_EXPANDER_ACCESSIBLE, GtkExpanderAccessible))
#define CTK_EXPANDER_ACCESSIBLE_CLASS(klass)      (G_TYPE_CHECK_CLASS_CAST ((klass), CTK_TYPE_EXPANDER_ACCESSIBLE, GtkExpanderAccessibleClass))
...
#define CTK_EXPANDER_ACCESSIBLE_GET_CLASS(obj)    (G_TYPE_INSTANCE_GET_CLASS ((obj), CTK_TYPE_EXPANDER_ACCESSIBLE, GtkExpanderAccessibleClass))
