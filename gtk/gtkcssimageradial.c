...
static void
ctk_css_image_radial_draw (GtkCssImage *image,
                           cairo_t     *cr,
                           double       width,
                           double       height)
{
...
static GtkCssImage *
ctk_css_image_radial_compute (GtkCssImage             *image,
                              guint                    property_id,
...
static GtkCssImage *
ctk_css_image_radial_transition (GtkCssImage *start_image,
...
static void
_ctk_css_image_radial_init (GtkCssImageRadial *radial)
{
