...
GtkWidget *ctk_color_selection_new                     (void);
GDK_DEPRECATED_IN_3_4_FOR(ctk_color_chooser_get_use_alpha)
gboolean   ctk_color_selection_get_has_opacity_control (GtkColorSelection *colorsel);
GDK_DEPRECATED_IN_3_4_FOR(ctk_color_chooser_set_use_alpha)
void       ctk_color_selection_set_has_opacity_control (GtkColorSelection *colorsel,
							gboolean           has_opacity);
GDK_DEPRECATED_IN_3_4
gboolean   ctk_color_selection_get_has_palette         (GtkColorSelection *colorsel);
GDK_DEPRECATED_IN_3_4
void       ctk_color_selection_set_has_palette         (GtkColorSelection *colorsel,
							gboolean           has_palette);


GDK_DEPRECATED_IN_3_4_FOR(ctk_color_chooser_set_rgba)
void     ctk_color_selection_set_current_alpha   (GtkColorSelection *colorsel,
						  guint16            alpha);
GDK_DEPRECATED_IN_3_4_FOR(ctk_color_chooser_get_rgba)
guint16  ctk_color_selection_get_current_alpha   (GtkColorSelection *colorsel);
GDK_DEPRECATED_IN_3_4
void     ctk_color_selection_set_previous_alpha  (GtkColorSelection *colorsel,
						  guint16            alpha);
GDK_DEPRECATED_IN_3_4
guint16  ctk_color_selection_get_previous_alpha  (GtkColorSelection *colorsel);

GDK_DEPRECATED_IN_3_4_FOR(ctk_color_chooser_set_rgba)
void     ctk_color_selection_set_current_rgba    (GtkColorSelection *colorsel,
                                                  const GdkRGBA     *rgba);
GDK_DEPRECATED_IN_3_4_FOR(ctk_color_chooser_get_rgba)
void     ctk_color_selection_get_current_rgba    (GtkColorSelection *colorsel,
                                                  GdkRGBA           *rgba);
GDK_DEPRECATED_IN_3_4
void     ctk_color_selection_set_previous_rgba   (GtkColorSelection *colorsel,
                                                  const GdkRGBA     *rgba);
GDK_DEPRECATED_IN_3_4
void     ctk_color_selection_get_previous_rgba   (GtkColorSelection *colorsel,
                                                  GdkRGBA           *rgba);

GDK_DEPRECATED_IN_3_4
gboolean ctk_color_selection_is_adjusting        (GtkColorSelection *colorsel);
...
GDK_DEPRECATED_IN_3_4
GtkColorSelectionChangePaletteWithScreenFunc ctk_color_selection_set_change_palette_with_screen_hook (GtkColorSelectionChangePaletteWithScreenFunc func);

GDK_DEPRECATED_IN_3_4_FOR(ctk_color_chooser_set_rgba)
void     ctk_color_selection_set_current_color   (GtkColorSelection *colorsel,
                                                  const GdkColor    *color);
GDK_DEPRECATED_IN_3_4_FOR(ctk_color_chooser_get_rgba)
void     ctk_color_selection_get_current_color   (GtkColorSelection *colorsel,
                                                  GdkColor          *color);
GDK_DEPRECATED_IN_3_4
void     ctk_color_selection_set_previous_color  (GtkColorSelection *colorsel,
                                                  const GdkColor    *color);
GDK_DEPRECATED_IN_3_4
void     ctk_color_selection_get_previous_color  (GtkColorSelection *colorsel,
                                                  GdkColor          *color);
